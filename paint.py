...
from tkinter import *
from tkinter import ttk#importacion de los modulos
...
class Paint:
    def __init__(self):
        ...
        #trabajando con canvas con la dimension
        self.w=600
        self.h=300
        #creacion del canva
        self.labinfo=Label(self.root, text="Paint Windows", width=50, font=("sans 14 bold"))
        self.labinfo.pack()
        self.my_canva=Canvas(self.root, width=self.w,height=self.h, bg="white")#creacion del canva
        self.my_canva.pack(pady=16)
        self.brush_color = "black"#configuracion de colores
        ...
        #chooser color
        self.root.mainloop()
    def clear_screen(self):#funcion que limpia el canva
